  ...
  return (
    <div>
      ...
      <Form.Group className="mb-3 w-25 text-center" controlId="formBasicEmail">
        ...
        <Form.Control type="text" placeholder="Provide Name" name='Name' onChange={handleChange} required />
      </Form.Group>
      <Form.Group className="mb-3 w-25 text-center" controlId="formBasicEmail">
        <Form.Label>Employee Number</Form.Label>
        <Form.Control type="text" placeholder="Provide EmployeeNumber" name='employeeno' onChange={handleChange} required />
      </Form.Group>

      <Form.Group className="mb-3 w-25 text-center" controlId="formBasicPassword">
        <Form.Label>Age</Form.Label>
        <Form.Control type="text" placeholder="Provide Age" name='Age' onChange={handleChange} required/>
      </Form.Group>
      <Form.Group className="mb-3 w-25 text-center" controlId="formBasicEmail">
        <Form.Label>Description</Form.Label>
        <Form.Control type="text" placeholder="Provide Description" name='Description' onChange={handleChange} required />
      </Form.Group>
